etc/MACSscore_summary_valid_fe.bed: data/SampleBEDs/*.bed data/FEfiles/*.xls
...
etc/all_samples.anno: data/SampleAnnos/*.anno
	python concat_sample_annos.py --anno_directory data/SampleAnnos --ignore chrM -o etc/all_samples.anno

results/ChIP_master_table.txt: etc/MACSscore_summary_valid_merged.bed data/mast_out.bed etc/MACSscore_summary_valid_fe.bed data/target.fa etc/MACSscore_summary_valid_merged.anno
	python -u master_table.py --merged_file etc/MACSscore_summary_valid_merged.bed --mast_file data/mast_out.bed --samples_file etc/MACSscore_summary_valid_fe.bed --fasta_file data/target.fa --anno_file etc/MACSscore_summary_valid_merged.anno -o results/ChIP_master_table.txt
